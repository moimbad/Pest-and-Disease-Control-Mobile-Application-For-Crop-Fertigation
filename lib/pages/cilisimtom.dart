...
{'symptom1': 'Wrinkle leaves', 'check': false },
{'symptom1': 'becomes small', 'check': false },
{'symptom1': 'curly', 'check': false},
];

List<Map<String, dynamic>> root = [
  {'symptom': 'no symptoms', 'check': false},
  {'symptom': 'smelly', 'check': false},
  {'symptom': 'dry', 'check': false},
];
List<Map<String, dynamic>> stem = [
  {'symptom2': 'stunted', 'check': false},
