...
List<Map<String, dynamic>> leaves = [
  {'symptom1': 'Round holes', 'check': false },
  {'symptom1': 'wrinkle', 'check': false },
  {'symptom1': 'eggs planted', 'check': false},
  {'symptom1': 'S shape', 'check': false},
  {'symptom1': 'mold', 'check': false},
];

List<Map< String,dynamic>> root = [
  {'symptom': 'eaten by larva', 'check': false},
  {'symptom': 'no symptoms', 'check': false},
];
List<Map<String, dynamic>> stem = [
  {'symptom2': 'no symptoms', 'check': false},
  {'symptom2': 'new shoots die', 'check': false},

];
class DressUpPage1 extends StatefulWidget {
  @override
  _DressUpPageState createState() => _DressUpPageState();
}

class _DressUpPageState extends State<DressUpPage1> {
