...
class DisplayPage5 extends StatefulWidget {
  final List<List<dynamic>> symptoms;

  DisplayPage5(this.symptoms);
  @override
  _DisplayPageState createState() => _DisplayPageState(symptoms);
}

class _DisplayPageState extends State<DisplayPage5> {
                      ...
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage(formalCombinations[i]['gambar']),
                              fit: BoxFit.fitWidth,
