...
import 'displayhaliaall.dart';
class HairDisplayPage2 extends StatelessWidget {
  @override
      ...
      child: Center(
        child: ElevatedButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => DisplayPage7(symptoms)),
            );
          },
        ),
      ),
